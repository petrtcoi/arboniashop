            ...
            { showHowReadModelBlock === true &&
                <Box marginTop="10px" padding="10px" sx={ { border: "1px solid #333333", borderRadius: "5px" } }>
                    <Typography sx={ styles.standardText } >
                        По цифромому обозначению модели Zehnder можно понять ее глубину и высоту.
                    </Typography>
                    ...
                    <Box textAlign="center" marginTop="20px">
                        ...
                        <Typography sx={ { ...styles.smallText } }>
                            ...
                            <br />
                            &#34;2&#34; - двухтрубчатый радиатор глубиной 62 мм
                            <br />&#34;3&#34; - трехтрубчатыйрадиатор глубиной 100 мм.
                            <br />&#34;4&#34; - четырехтрубчатыйрадиатор глубиной 136 мм.
                            <br />&#34;5&#34; - пятитрубчатыйрадиатор глубиной 173 мм.
                            <br />&#34;6&#34; - шеститрубчатыйрадиатор глубиной 210 мм.<br /><br />
                            Чем больше труок в секции,тем мощнее и толще радиатор<br /><br />
                            В данном примере радиатор 3-трубчатый, глубиной 100 мм.
                        </Typography>
                    </Box>
                    <Box textAlign="center" marginTop="30px">
                        <Typography sx={ { ...styles.standardTextThin, fontSize: "20px" } } display="inline">
                        ...
                        <Typography sx={ { ...styles.smallText } }>
                            ...
                            В данном примере радиатор имеет высоту 566 мм (примерно 57 см)
                        </Typography>
                    </Box>
                    <Box marginTop="20px" />
                </Box>
