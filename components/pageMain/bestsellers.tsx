    ...
    <Box>
      ...
      <Box marginTop="20px" maxWidth="700px">
        <Typography sx={{ ...styles.smallText }}>
          Наша компания может предложить широкий ассортимент трубчатых радиаторов Arbonia, включая модели, поставляемые под заказ. Наиболее популярные модели поддерживаются в наличии на наших складах в Москве и Санкт-Петербурге и представлены ниже. Они могут быть поставлены в любой город России в кратчайшие сроки.
        </Typography>
      </Box>
      <Box
        marginTop="40px"
        ...
        <Grid container alignItems={"stretch"} spacing={4}>
          ...
          >
            <Box >
              ...
              <Box paddingX="15px">
                <Typography sx={{ ...styles.smallText, }}>
                  Самая популярная модель трубчатого радиатора Arbonia. Подходит для установки в узких нишах. Благодаря большой высоте обладает высокой теплоотдачей.
                </Typography>
                <Box marginTop="15px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                  <Box sx={{ ...styles.smallText }}>Тип модели</Box>
                  <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                  <Box sx={{ ...styles.smallText }}>2-трубчатый радиатор</Box>
                </Box>
                <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                  <Box sx={{ ...styles.smallText }}>Высота</Box>
                  <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                  <Box sx={{ ...styles.smallText }} itemProp="height">180 см</Box>
                </Box>
                <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                  <Box sx={{ ...styles.smallText }}>Толщина</Box>
                  <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                  <Box sx={{ ...styles.smallText }} itemProp="depth">65 мм</Box>
                </Box>
                <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                ...
                <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                  ...
                  <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                  <Box sx={{ ...styles.smallText }}>белый, RAL 7016, SF-3
                  </Box>
                </Box>
                <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                ...
                >
                  ...
                  <meta itemProp="lowPrice" content={model2180MinPrice.noConsole.toString()} />
                  <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                  <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                  <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model2180MinPrice.noConsole.toLocaleString()} руб.</Box>
                </Box>
              </Box>
            </Box>
            <Box marginTop="25px">
          ...
          >
            ...
            <Box paddingX="15px">
              <Typography sx={{ ...styles.smallText, }}>
                Трехтрубчатый горизонтальный радиатор для установки под окна. При боковом подключении имеет стандартное межосевое расстояние 500 мм, которое позволяет устанавливать его вместо старых алюминиевых или чугунных батарей.
              </Typography>
              <Box marginTop="15px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Тип модели</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Высота</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText }} itemProp="height">57 см</Box>
              </Box>
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Толщина</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText }} itemProp="depth">105 мм</Box>
              </Box>
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Мощность секции (ΔT=60°)</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              >
                <meta itemProp="priceCurrency" content="RUB" />
                <meta itemProp="lowPrice" content={model3057MinPrice.noConsole.toString()} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model3057MinPrice.noConsole.toLocaleString()} руб.</Box>
              </Box>
              <Box marginTop="25px">
                <Button
                  fullWidth
          ...
          >
            ...
            <Box paddingX="15px">
              <Typography sx={{ ...styles.smallText, }}>
                Трехтрубчатый вертикальный радиатор. Обладает наибольшей мощностью среди всех складских моделей Arbonia. Подходит для установки в больших помещениях с высокими потолками.
              </Typography>
              <Box marginTop="15px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Тип модели</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              >
                <meta itemProp="priceCurrency" content="RUB" />
                <meta itemProp="lowPrice" content={model3180MinPrice.noConsole.toString()} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model3180MinPrice.noConsole.toLocaleString()} руб.</Box>
              </Box>
              <Box marginTop="25px">
                <Button
                  fullWidth
          ...
          >
            ...
            <Box paddingX="15px">
              ...
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Высота</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText }} itemProp="height">30 см</Box>
              </Box>
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Толщина</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              >
                <meta itemProp="priceCurrency" content="RUB" />
                <meta itemProp="lowPrice" content={model3030MinPrice.noConsole.toString()} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model3030MinPrice.noConsole.toLocaleString()} руб.</Box>
              </Box>
              <Box marginTop="25px">
                <Button
                  fullWidth
          ...
          >
            ...
            <Box paddingX="15px">
              <Typography sx={{ ...styles.smallText, }}>
                Плоских двухтрубчатый радиатор высотой. Стандартная высота 50 см - для установки под окна. Боковое и нижнее подключение. В наличии в белом цвете.
              </Typography>
              <Box marginTop="15px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Тип модели</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Высота</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText }} itemProp="height">50 см</Box>
              </Box>
              <Box marginTop="7px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Толщина</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              >
                <meta itemProp="priceCurrency" content="RUB" />
                <meta itemProp="lowPrice" content={model2050MinPrice.noConsole.toString()} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model2050MinPrice.noConsole.toLocaleString()} руб.</Box>
              </Box>
              <Box marginTop="25px">
                <Button
                  fullWidth
          ...
          >
            ...
            <Box paddingX="15px">
              <Typography sx={{ ...styles.smallText, }}>
                Трехтрубчатый радиатор высотой 50 см. Боковое и нижнее подключение. В наличии в белом цвете. Модель является более мощной, чем 2050.
              </Typography>
              <Box marginTop="15px" display="flex" flexDirection={"row"} alignItems={"bottom"} width="100%" gap={1}>
                <Box sx={{ ...styles.smallText }}>Тип модели</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
              ...
              >
                <meta itemProp="priceCurrency" content="RUB" />
                <meta itemProp="lowPrice" content={model3050MinPrice.noConsole.toString()} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>Цена</Box>
                <Box sx={{ borderBottom: "1px dotted black" }} flexGrow={1} />
                <Box sx={{ ...styles.smallText, fontWeight: 600 }}>от {model3050MinPrice.noConsole.toLocaleString()} руб.</Box>
              </Box>
              <Box marginTop="25px">
                <Button
                  fullWidth
