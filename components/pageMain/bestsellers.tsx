		...
		<Box>
			...
			>
				<Typography sx={{ ...styles.standardText }}>
					Наша компания может предложить широкий ассортимент трубчатых
					радиаторов Arbonia, включая модели, поставляемые под заказ. Наиболее
					популярные модели поддерживаются в наличии на наших складах в Москве и
					Санкт-Петербурге и представлены ниже. Они могут быть поставлены в
					любой город России в кратчайшие сроки.
				</Typography>
			</Box>
			<Box
				marginTop='40px'
			...
			>
				...
				>
						...
						<Box>
							...
							<Box paddingX='15px'>
								<Typography sx={{ ...styles.smallText }}>
									Самая популярная модель трубчатого радиатора Arbonia. Подходит
									для установки в узких нишах. Благодаря большой высоте обладает
					...
					>
						...
						<Box paddingX='15px'>
							<Typography sx={{ ...styles.smallText }}>
								Трехтрубчатый горизонтальный радиатор для установки под окна.
								При боковом подключении имеет стандартное межосевое расстояние
								500 мм, которое позволяет устанавливать его вместо старых
								алюминиевых или чугунных батарей.
							</Typography>
							<Box
								marginTop='15px'
								display='flex'
					...
					>
						...
						<Box paddingX='15px'>
							<Typography sx={{ ...styles.smallText }}>
								Трехтрубчатый вертикальный радиатор. Обладает наибольшей
								мощностью среди всех складских моделей Arbonia. Подходит для
								установки в больших помещениях с высокими потолками.
							</Typography>
							<Box
								marginTop='15px'
								display='flex'
					...
					>
						...
						<Box paddingX='15px'>
							<Typography sx={{ ...styles.smallText }}>
								Низкий 3-трубчатый радиатор. Высота: 30 см. Боковое и нижнее
								подключение. В наличии в белом цвете. Подходит для установки под
								окна с низкими подоконниками.
							</Typography>
							<Box
								marginTop='15px'
								display='flex'
					...
					>
						...
						<Box paddingX='15px'>
							<Typography sx={{ ...styles.smallText }}>
								Плоских двухтрубчатый радиатор высотой. Стандартная высота 50 см
								- для установки под окна. Боковое и нижнее подключение. В
								наличии в белом цвете.
							</Typography>
							<Box
								marginTop='15px'
								display='flex'
					...
					>
						...
						<Box paddingX='15px'>
							<Typography sx={{ ...styles.smallText }}>
								Трехтрубчатый радиатор высотой 50 см. Боковое и нижнее
								подключение. В наличии в белом цвете. Модель является более
								мощной, чем 2050.
							</Typography>
							<Box
								marginTop='15px'
