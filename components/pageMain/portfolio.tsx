    ...
    <Box>
      ...
      <Box textAlign="center" marginY="80px">
        <Typography sx={{ ...styles.standardText }}>
          У нас богатый опыт работы с различными проектами:
          <br />
          От крупных коммерческих объектов, до замены единственного радиатора в
          комнате.
          <br />
          Свяжитесь с нами и мы гарантируем качественное обслуживание и поставку
          радиаторов в срок!
          <br />
