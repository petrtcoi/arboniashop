      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          ...
          <Typography sx={{ ...styles.standardText }}>
            Мы работаем с 2009 года и за это время накопили огромный опыт работы
            с продукцией фирмы Arbonia. Он позволяет нам подобрать оптимальный
            вариант для каждого заказчика, исходя из его предпочтений, желаемого
            бюджета и технических особенностей строительного объекта. Среди
