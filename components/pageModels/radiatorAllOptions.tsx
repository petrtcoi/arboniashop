		...
		<Box>
			...
			{modelFreeze && modelCurr && (
				<Box marginY='20px'>
					...
					<Typography sx={styles.standardText}>
						Если вам нужна помощь в подборе радиаторов,то мы с радостью проконсультируем и поможем с выбором наиболее
						подходящих моделей
					</Typography>
				</Box>
			)}
					...
					>
						<Box marginTop='50px'>
							...
							<Box
								...
								paddingLeft='10px'
							>
								<Typography sx={styles.standardTextThin}>высота: {modelCurr.height} мм</Typography>
								<Typography sx={styles.standardTextThin}>глубина: {modelCurr.width} мм</Typography>
