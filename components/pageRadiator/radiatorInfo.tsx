            ...
            <Grid container spacing={ 2 }>
                ...
                <Grid item xs={ 12 } sm={ 6 }>
                    <Box marginTop="30px" marginLeft="20px">
                        ...
                        {/* БЛОК ЦЕНЫ */ }
                        <Box marginTop="20px" padding="10px" sx={ { border: "1px solid #333333", borderRadius: "10px" } } textAlign="center">
                            <Box>
                        ...
                        <Box marginTop="30px">
                            <Box>
                                ...
                                <Box paddingLeft="30px">
                                    <Box>
                                        <Typography sx={ styles.smallText } display="inline" itemProp="model">
                                            Модель:&nbsp;
                                        </Typography>
                                    ...
                                    <Box>
                                        <Typography sx={ styles.smallText } display="inline" itemProp="color">
                                            Цвет:&nbsp;
                                        </Typography>
                                        <Typography sx={ styles.smallTextBold } display="inline">
                                            { color.nameShort }
                            ...
                            <Box marginTop="30px">
                                ...
                                <Box paddingLeft="30px">
                                    ...
                                    <Box>
                                        ...
                                        <Typography sx={ styles.smallTextBold } display="inline" itemProp="height">
                                            { model.height } мм
                                        </Typography>
                                    </Box>
                                    <Box>
