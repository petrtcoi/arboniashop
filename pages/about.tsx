...
const PageAbout: NextPage<PageAboutProps> = () => {
    ...
    return (
        <Box itemScope itemType="https://schema.org/Organization">
            ...
            />
            <PageHeader title={ "О магазине радиаторов Zehnder" } />
            <Hero
            ...
            <Box sx={ { ...global.pagePadding } } marginTop="20px">
                    ...
                    <Grid container spacing={ 2 }>
                        <Grid item xs={ 12 } md={ 7 } lg={ 6 }>
                            <Typography sx={ { ...styles.standardText } } component={ "span" }>
                                ...
                                <ul>
                                    <li>Стальные трубчатые радитаоры Zehnder Charleston</li>
                                    <li>Полотенцесушители и дизайн-радиаторы</li>
                                    <li>Потолочные панели (для коммерческих и жилых помещений)</li>
                                    <li>Системы централизованной и децентрализованной вентиляции Zehnder</li>
                                </ul>
                        ...
                        <Grid item xs={ 12 } md={ 4 } lg={ 3 }>
                            ...
                            <Box>
                                ...
                                <Link href={ `https://t.me/Zehndersbot` }>
                                    <a
                                        style={ { textDecoration: "none" } }
                ...
                <Box>
                    ...
                    <Box marginTop="30px">
                        <a href="/docs/cert.jpg" download>
                            <img src="/docs/cert.jpg" width="400px" />
                        </a>
                    </Box>
                </Box>
            </Box>
