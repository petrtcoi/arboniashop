    ...
    return (
        <Box sx={ { ...global.pagePadding } }>
            ...
            <Typography sx={ { ...styles.standardText } }>
                Настоящий документ «Пользовательское соглашение» (далее — Соглашение) представляет собой предложение ООО «Маус Лайт», размещенное на сайте www.zehnders.ru (далее — «Сайт»), заключить договор на изложенных ниже условиях Соглашения.
            </Typography>
            ...
            <Typography sx={ { ...styles.standardText } }>
                2.1.Сайт осуществляет продажу товара посредством веб-ресурса www.zehnders.ru и сопутствующих сервисных служб Сайта.
                ...
                Подписываясь на SMS- и email-рассылку www.zehnders.ru  или третьих лиц, уполномоченных на рассылку от имени www.zehnders.ru , в сети Интернет www.zehnders.ru, я соглашаюсь получать информационную рассылку на телефон и электронный адрес, указанный мной при подписке через сервис подписки информационной рассылки на сайте www.zehnders.ru . Я проинформирован о том, что в случае, если у меня возникнет желание отказаться от информационной рассылки  www.zehnders.ru, мне будет необходимо написать соответствующий запрос на электронную почту sales@mouselite.ru или же сообщить о несогласии получения информационных рассылок по адресам, указанным в разделе «Контакты» данного Соглашения. Я также даю разрешение Сайту или третьим лицам, уполномоченным на рассылку от имени Сайта, собирать, хранить и обрабатывать все переданные мною в адрес Сайта персональные данные (в том числе фамилию, имя, отчество и адрес электронной почты) с целью информирования о новостях и других событиях Сайта.
            ...
            <Typography sx={ { ...styles.standardText } }>
                ...
                <br />4.3.Политика конфиденциальности доступна по ссылке – www.zehnders.ru/privacy.
            </Typography>
