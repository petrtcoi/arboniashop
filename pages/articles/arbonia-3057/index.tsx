		...
		<Box>
			...
			<Box sx={{ ...global.pagePadding, maxWidth: '900px', margin: 'auto' }}>
				...
				>
					...
					демонтажа старых батарей. Однако совпадение одного размера не гарантирует монтаж без изменений: нужно проверить
					глубину выводов, резьбу, сторону подачи и арматуру. Подробная схема замера приведена в статье про&#160;
					<a
						style={{ textDecoration: 'none' }}
				...
				>
					...
					расположение батареи к стене. Из-за этого 2-трубчатый радиатор редко выбирается на роль замены старых
