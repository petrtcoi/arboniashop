	...
	return (
		<Box>
			<PageHeader
				...
				description={
					'Трубчатые радиаторы Arbonia - один из признанных лидеров европейского и российского рынка, когда речь заходит о дизайнерских отопительных приборах. Разбираем, чем они так хороши и какие недостатки у них все же имеются.'
				}
			/>
			<PageTitle
				breadcrumbs={[
					...
					<ul>
						<li>
							<Box sx={{ ...styles.standardText }}>
								...
								заметно меньше, чем эксклюзивные декоративные радиаторы. По соотношению цена / качество - это одно из лучших
