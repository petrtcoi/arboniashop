			...
			<Box sx={{ ...global.pagePadding, maxWidth: '900px', margin: 'auto' }}>
				...
				<Box>
					<Typography
						...
						marginY='20px'
					>
						Поэтому радиаторы Arbonia высотой до 40 см входят в нашу складскую программу. Если вы начинаете подбор с
						размеров оконной ниши, используйте практическое руководство про{' '}
						<a
						...
						>
							<Typography
								...
								component='span'
							>
								выбор радиатора под низкий подоконник
							</Typography>
						</a>
						. Там разобраны замер от чистового пола, глубина корпуса, монтажные зазоры и расчет секций Arbonia 2030 и
						3030. Это помогает отсеять неподходящую модель до оформления заказа и согласования подключения.
					</Typography>
				</Box>
				<Box>
					<Typography
