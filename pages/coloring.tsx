            ...
            <Box sx={ { ...global.pagePadding } }>
                <Box sx={ { maxWidth: "900px", margin: "auto" } }>
                    <Typography sx={ { ...styles.standardText, marginTop: "20px" } }>
                        В складскую программу входят только наиболее популярные цвета радиаторов Arbonia. Если вы не нашли нужный вам цвет,то мы можем разместить заказ на заводе и доставить радиатор в требуемом цвете. Обычно, выполнение заказа и доставка могут занимать от 2 до 4 месяцев,в зависимости от загруженности завода.Актуальные сроки уточняйте у менеджеров магазина.
                    </Typography>
                    <Typography sx={ { ...styles.standardText, marginTop: "20px" } }>
                        Если радиаторы требуются быстрее, то можно наша компания может осуществить покраску радиаторов из наличия в <span style={ { ...styles.standardTextRed } }>любой цвет из палитры RAL</span>. Срок выполнения заказа составит <span style={ { ...styles.standardTextRed } }>не более 1-2 недель</span>. Свяжитесь с нами любым удобным для вас способом для уточнения актуальных на данный момент сроков покраски, наличия и стоимости радиаторов. Также, вы можете заполнить форму ниже, указав в комментариях желаемый цвет радиаторов.
                    </Typography>
                    <Typography sx={ { ...styles.standardText, marginTop: "20px" } }>
                    ...
                    <Grid container spacing={ 2 } alignItems={ "center" }>
                        <Grid item xs={ 12 } sm={ 4 } textAlign="center">
                            ...
                            <Link href={ `tel:${global.phone495}` }>
                                ...
                                >
                                    <Typography sx={ { ...styles.standartTextLink, color: "white" } } display="inline">
                ...
                {
                    show &&
                    <Box padding="20px" sx={ { backgroundColor: "#e6e6e6", borderRadius: "10px" } }>
                        <Typography sx={ { ...styles.standardText } } component={ "span" }>
                            Информация, которая нужна для правильного побора радиаторов:
                            (если каких-то данных пока нет - то можно отправить то, что уже известно)
                            <ul>
                                <li>Размеры помещений, высота потолков</li>
                                <li>Желаемое место расположения радиаторов. Доступные габариты. Например, если радиатор ставится под окно, то: высота подоконника и длина окна</li>
                                <li>Если возможно - план квартиры / дома, что упростит общение</li>
                                <li>Тип подключения радиаторов в вашем доме: индивидуальная разводка труб по полу или общий стояк отопления</li>
                                <li>Город доставки</li>
                            </ul>
                            Любую иную информацию, которая вам кажется важной и которую нам необходимо учесть.
                            Оставьте ваши контактные данные, чтобы мы могли связаться с вами и получить дополнительную информацию в случае необходимости.
                        </Typography>
                    </Box>
                }
