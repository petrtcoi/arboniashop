...
const Model2057: React.FC<SetComponentProps> = ({ models, colors, connections }: Props) => {
	...
	return (
		...
		>
			...
			<PageHeader
				...
				description='Двухтрубчатые радиаторы Arbonia 2057 в наличии (высота 57 см). 📦 Склады в Мск и СПб. 🛡️ Официальная гарантия 10 лет. 🚚 Доставка по России.'
			/>
			<PageTitle
			...
			<Hero
				...
				subheader={'Двухтрубчатые радиаторы Arbonia высотой 57 см и межосевым расстоянием 50 см'}
			/>
			...
			<Box sx={{ ...global.pagePadding }}>
				...
				>
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 2057 с боковым подключением
						</Typography>
					</Box>
					<Box
						onClick={() => {
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 2057 с нижним подключением
						</Typography>
					</Box>
					<Box
						onClick={() => {
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 2057 под заказ
						</Typography>
					</Box>
				</Box>
				...
				<Box marginTop='20px'>
					<Typography sx={{ ...styles.standardText }}>
						<p>
							Радиатор Arbonia 2057 - двухтрубчатая модель высотой 57 см. Он идеально подойдет для установки под
							стандартные окна, оставляя достаточно места для подключения снизу и под подоконником. Толщина радиатора
							составляет всего 65 мм, что придает ему изысканный внешний вид. При небольших габаритах, радиатор обладает
							достаточно высокой тепловой мощностью: 54 Вт (ΔT=60°). Модель доступна в наличии с боковым и с нижним
							подключением.
						</p>
						<p>
						...
						<h2 style={{ marginTop: '40px' }}>Технические характеристики радиатора Arbonia 2057</h2>
						<p>
							<span style={{ ...styles.smallTextBold }}>Высота секции: 57 см.</span> Радиатор подходит для установки под
							стандартные окна (высота подоконника от 80 см). При боковом подключении радиатор имеет стандартное
							межосевое расстояние 50 см и идеально подойдет для замены старых чугунных или алюминиевых батарей.
						</p>
						<p>
						...
						<p>
							<span style={{ ...styles.smallTextBold }}>Мощность секции: 54 Вт (ΔT=60°).</span> При среднем расчете 100
							Вт/м2, такой секции будет достаточно для обогрева 0.54 кв.м. В случае хорошей теплоизоляции дома, одной
				...
				>
					<Typography sx={{ ...styles.standardText }}>
						<h2>Радиаторы Arbonia 2057 с боковым подключением</h2>
						<Grid
							container
							spacing={2}
						>
							...
							>
								<p>
									...
									модели с боковым подключением 3/4, подходящим для российских домов. Межосевое расстояние 50 см
									является стандартным для нашей страны.
								</p>
								<p>
				...
				>
					<Typography sx={{ ...styles.standardText }}>
						<h2>Радиаторы Arbonia 2057 с нижним подключением</h2>
						<Grid
							container
							spacing={2}
						>
							...
							>
								...
								<p>
									В наличии поддерживаются радиаторы Arbonia 2057 с нижним подключением 69 ТВВ. Это одностороннее
				...
				<Box
					...
					ref={refOrder}
				>
					<h2>Купить радиаторы Arbonia 2057</h2>
					<Typography sx={{ ...styles.standardText }}>
						Если вы не нашли подходящего варианта из складской программы, то радиаторы Arbonia 2057 можно заказать на
