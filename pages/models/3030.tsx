...
const Model3030: React.FC<SetComponentProps> = ({
  ...
  return (
    <Box>
      <PageHeader
        title={
          "Радиаторы Arbonia 3030 в наличии | Выгодные цены и доставка в любой город России | ArboniaShop.ru"
        }
        description="Радиаторы Arbonia 3030 в наличии. Выгодные цены и доставка в любой город России. Высота секции - 30 см. Глубина секции - всего 105 мм. Официальная гарантия на всю продукцию."
      />
      <Hero
        imgPath={"/images/sliders/slide.jpeg"}
        header={"Радиаторы Arbonia 3030"}
        subheader={"3-трубчатый радиатор Arbonia высотой 30 см"}
      />
