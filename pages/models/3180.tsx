...
const Model3180: React.FC<SetComponentProps> = ({ models, colors, connections }: Props) => {
			...
			<Box sx={{ ...global.pagePadding }}>
				...
				>
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 3180 в белом цвете
						</Typography>
					</Box>
					<Box
						onClick={() => {
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 3180 в цвете RAL 7016
						</Typography>
					</Box>
					<Box
						onClick={() => {
					...
					>
						<Typography sx={{ ...styles.smallTextRedLink, cursor: 'pointer' }}>
							Радиаторы Arbonia 3180 SF-3 Antrazit metallic
						</Typography>
					</Box>
					<Box
						onClick={() => {
				...
				<Box marginTop='20px'>
					<Typography sx={{ ...styles.standardText }}>
						<p>
							Радиатор Arbonia 3180 - это самая мощная модель от данного производителя, которую можно найти в наличии на
							складе. Она сочетает в себе высокую тепловую мощность (одна секция может обогреть в среднем от 2 до 4
						...
						<h2 style={{ marginTop: '40px' }}>Технические характеристики радиатора Arbonia 3180</h2>
						<p>
						...
						<p>
							<span style={{ ...styles.standardTextRed }}>Глубина секции: 105 мм.</span> Радиатор имеет стандартную
							толщину для отопительного прибора и без проблем встанет в любую нишу.
						</p>
						<p>
							<span style={{ ...styles.standardTextRed }}>Мощность секции: 219 Вт (ΔT=60°).</span> При среднем расчете
							100 Вт/м2, такой секции будет достаточно для обогрева 2.2 кв.м. Для хорошо утепленных домов площадь
							отопления может составить до 4-6 кв.м. Данные характеристики необходимо уточнять по проектной документации
							дома.
						</p>
					</Typography>
				</Box>
				...
				>
					<Typography sx={{ ...styles.standardText }}>
						<h2>Радиаторы Arbonia 3180 RAL 9016</h2>
						<Grid
							container
							spacing={2}
						>
							...
							>
								<p>
									...
									берите Arbonia 3180 в белом цвете.
								</p>
						...
						>
							...
							>
								<img
									...
									alt='Белый радиатор Arbonia 3180 RAL 9016 69 ТВВ'
									style={{ maxWidth: '100%', height: 'auto' }}
									// width={600}
									// height={600}
								/>
				...
				>
					<Typography sx={{ ...styles.standardText }}>
						<h2>Радиаторы Arbonia 3180 RAL7016</h2>
						<Grid
							container
							spacing={2}
						>
				...
				>
					<Typography sx={{ ...styles.standardText }}>
						<h2>Радиаторы Arbonia 3180 SF-3</h2>
						<Grid
							container
							spacing={2}
						>
				...
				<Box marginTop='50px'>
					<Typography sx={{ ...styles.standardText }}>
						Здесь мы отобразили все модели Arbonia 3180 доступные к покупке со склада. Если среди предложенных вариантов
				...
				<Box
					...
					ref={refOrder}
				>
					<h2>Купить радиаторы Arbonia 3180 под заказ</h2>
					<Typography sx={{ ...styles.standardText }}>
						Если вы не нашли подходящего варианта из складской программы, то радиаторы Arbonia 3180 можно заказать на
