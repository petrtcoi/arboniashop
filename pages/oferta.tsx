...
const OfertaPage: NextPage<OfertaPageProps> = () => {
    ...
    return (
        <Box sx={ { ...global.pagePadding } }>
            ...
            <Typography sx={ { ...styles.standardText } }>
                3.1.Цены на товар определяются Продавцом в одностороннем бесспорном порядке и указываются на страницах интернет-магазина, расположенного по интернет-адресу: www.zehnders.ru.
                <br />
