...
const PrivacyPage: NextPage<PrimacyPageProps> = () => {
    ...
    return (
        <Box sx={ { ...global.pagePadding } }>
            ...
            <Typography sx={ { ...styles.standardText } }>
                1.1. Настоящая Политика является неотъемлемой частью Публичной оферты (далее – «Оферта»), размещенной и/или доступной в сети Интернет по адресу: http://zehnders.ru/oferta а также иных заключаемых с Пользователем договоров, когда это прямо предусмотрено их условиями.
                <br />
