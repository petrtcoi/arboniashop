						...
						>
							...
							>
								...
								<Typography sx={{ ...styles.standardText }}>
									<p>
										Радиатор Arbonia 2180 08 секций - компактный вертикальный радиатор шириной {width} мм. Радиатор
										может являться единственным источником тепла при обогреве средних помещений. В остальных ситуациях,
										Arbonia 2180 08 должен работать как дополнительный источник тепла. Например, его можно разместить у
										выхода на балкон.
									</p>
									<p>
